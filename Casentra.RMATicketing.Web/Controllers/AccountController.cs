...
using Casentra.RMATicketing.Web.Controllers.Results;
using Casentra.RMATicketing.Web.Models.Account;
...
{
    public class AccountController : RMATicketingControllerBase
    {
        ...
        {
            return RegisterView(new RegisterViewModel {TenancyName= "SUIVI-RMA" });
            }

        private ActionResult RegisterView(RegisterViewModel model)
        {
            ViewBag.IsMultiTenancyEnabled = false;// _multiTenancyConfig.IsEnabled;
            model.TenancyName  = "SUIVI-RMA";
